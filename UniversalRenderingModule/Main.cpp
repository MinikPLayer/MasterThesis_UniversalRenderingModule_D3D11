...
LPCWSTR g_szAppName = L"UniversalRenderingModule";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    //    HWND hwnd = CreateWindowExW(0, L"UniversalRenderingModuleWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
    //        CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top,
    //        nullptr, nullptr, hInstance,
    //        g_game.get());
    //    // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"UniversalRenderingModuleWindowClass", g_szAppName, WS_POPUP,
